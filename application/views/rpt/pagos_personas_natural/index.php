    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-8 text-right" id="showbtns">
                <a class="btn btn-primary btnexportarpocurso" href="http://intranet.safesi.com/RptController/expPagosPersonasNaturales" target="_top" rel="tooltip" title="Exportar"><i class="material-icons">print</i> Exportar</a>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header" data-background-color="blue">
                        <h4 class="title"> <span>Pagos Personas Naturales</span> <span style="float: right;" id="totalpgspn">...</span></h4>
                    </div>
