        ...
        <div class="container-fluid">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content card">
                            ...
                            <div class="modal-footer">
                                <button type="submit" id="btnSaveAlumnoGrupo" class="btn btn-primary">Agregar</button>
            ...
            <!-- .......... -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-3"><input type="button" value="Atras" class="btn btn-btn-defauld" onClick="window.location.reload()"></div>
                    <div class="col-md-1"></div>
                    <div class="col-md-8 text-right" id="showbtns">
                        <a class="btn btn-warning btnimplisasis" rel="tooltip" title="Imprimir Lista de Asistencia"><i class="material-icons">print</i> Asistencia</a> 
                        <a class="btn btn-primary btnimpnotas" rel="tooltip" title="Imprimir Registro de Notas"><i class="material-icons">print</i> Notas</a> <button type="button" id="btnAddAlumnoGrupo" class="btn btn-success" data-toggle="modal">
                        ...
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="row">
                                    ...
                                    <div class="row hidden" id="dvbtnconfirmar">
                                        ...
                                        <div class="col-md-4 text-right">
                                            <form id="formconflistalum" method="POST">
                                                ...
                                                <button type="button" class="btn btn-primary" id="btnConfirmAlumnos" data-toggle="tooltip" data-placement="bottom" data-original-title="Cerrar Alumnos">
                                                <i class="material-icons">lock_open</i> Cerrar Grupo</button>
                                            </form>
                                        </div>
                                    </div>

                                    <div class="row hidden" id="dvbtnreabrir">
                                        <div class="col-md-8"></div>
                                        <div class="col-md-4 text-right">
                                            <form id="formreablistalum" method="POST">
                                                <input type="hidden" name="txtidgrupr" id="txtidgrupr">
                                                <input type="hidden" name="txtidcursr" id="txtidcursr">
                                                <button type="button" class="btn btn-danger" id="btnReabrirAlumnos" data-toggle="tooltip" data-placement="bottom" data-original-title="Reabrir Grupo">
                                                <i class="material-icons">lock_outline</i> Reabrir Grupo</button>
                                            </form>
                                        </div>
                                    </div>
                            </div>
